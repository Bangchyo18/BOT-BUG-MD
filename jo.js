...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    if (!isCreator) return
            ...
            break
case 'sc': {
m.reply(`\n▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬\n│➳ 𝚂𝚞𝚋𝚜𝚌𝚛𝚒𝚋𝚎 𝙼𝚢 𝚈𝚘𝚞𝚝𝚞𝚋𝚎\n│➳ https://bit.ly/3y8H1ub\n▬▭▬▭▬ ✦✧✦ ▬▭▬▭▬\n`)
            }
            break

case 'ajg': case 'anjing': case 'memek': case 'kntl': case 'ngentot': case 'babi': case 'gblk': case 'goblok': case 'bngst': case 'tolol': case 'ngntd': case 'anjg': case 'bacot': case 'anj': case 'kontol': case 'pantek': case 'bego': case 'mmk': case 'gblg':  case 'kntl': case 'bangsat': case 'bngst': case 'bct': case 'pntek': case 'ngntot': case 'asu': case 'bajingan': case 'pukimak': case 'puki': case 'jancok': {
m.reply('Jangan Toxic Sayangkuh 🥰')
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dosa pantek.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break
 
case 'assalamu\'alaikum': case 'Assalamu\'alaikum': case 'assalamualaikum': case 'Assalammualaikum': {
m.reply ('waalaikumsalam warahmatullahi wabarakatuh')
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/Walaikumsalam.mp3'), mimetype: 'audio/mpeg', ptt:true }) 
   }
   break
   
case 'Y':  case 'y': case 'O': case '?': case '.': case 'F': case 'ok': case 'Ok': case 'Oh': case 'oh': case 'Ya': case 'ya': {
m.reply('dingin cuy pantes sepi atmin nya aja dingin 🥶🥶')
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dingincuy.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break
   
case 'sound1': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/selalu salah.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break

case 'sound2': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/ytta.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break

case 'sound3': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/banyak luka.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break

case 'sound4': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dj1.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break

case 'sound5': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dahlah.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break
   
case 'sound6': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dj2.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break

case 'sound6': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dj3.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break
   
case 'sound7': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dj4.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break

case 'sound8': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dj5.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break
   
case 'sound9': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dj6.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break

case 'sound10': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dj7.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break

case 'sound11': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dj8.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break

case 'sound12': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dj9.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break

case 'sound13': {
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dj10.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://youtube.com/channel/UCZkSu7CSK9t-LRhW-Nd82_Q'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: '+62 812-2630-6638'
                                }
                            }, {
                                quickReplyButton: {
...
case 'menu': {
m.reply('🐦')
jobotz.sendMessage(m.chat, {audio: fs.readFileSync('./src/dj.mp3'), mimetype: 'audio/mpeg', ptt:true })
   }
   break
  ...
  break
          ...
          if (!text) throw `Nomernya mana?`
             asukonyol11 = { 
                    ...
                    message: { 
                        "imageMessage": { 
                            "mimetype": "image/jpeg", 
                            "caption": `𝚃𝙷𝙴 𝙲𝙰𝙷𝚈𝙾 𝙱𝙾𝚃𝚉 𝙸𝙽𝙵𝙸𝙽𝙸𝚃𝙴`,
                            "jpegThumbnail": virgam
                        } 
                    } 
                }
            await jobotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝚃𝙷𝙴 𝙲𝙰𝙷𝚈𝙾 𝙱𝙾𝚃𝚉 𝙸𝙽𝙵𝙸𝙽𝙸𝚃𝙴"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝚃𝙷𝙴 𝙲𝙰𝙷𝚈𝙾 𝙱𝙾𝚃𝚉 𝙸𝙽𝙵𝙸𝙽𝙸𝚃𝙴"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝚃𝙷𝙴 𝙲𝙰𝙷𝚈𝙾 𝙱𝙾𝚃𝚉 𝙸𝙽𝙵𝙸𝙽𝙸𝚃𝙴"},{quoted:asukonyol11})
        ...
        case 'gassantet': {          
          ...
          if (!text) throw `Nomernya mana?`
            ...
            await jobotz.sendMessage(m.chat, {text:"𝚃𝙷𝙴 𝙲𝙰𝙷𝚈𝙾 𝙱𝙾𝚃𝚉 𝙸𝙽𝙵𝙸𝙽𝙸𝚃𝙴"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(`${text}@s.whatsapp.net`, {text:"𝚃𝙷𝙴 𝙲𝙰𝙷𝚈𝙾 𝙱𝙾𝚃𝚉 𝙸𝙽𝙵𝙸𝙽𝙸𝚃𝙴"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(m.chat, {text:"𝚃𝙷𝙴 𝙲𝙰𝙷𝚈𝙾 𝙱𝙾𝚃𝚉 𝙸𝙽𝙵𝙸𝙽𝙸𝚃𝙴"},{quoted:asukonyol11})
          ...
          if (!isCreator && !isBan) return
             asukonyol11 = { 
                    ...
                    message: { 
                        "imageMessage": { 
                            "mimetype": "image/jpeg", 
                            "caption": `𝚃𝙷𝙴 𝙲𝙰𝙷𝚈𝙾 𝙱𝙾𝚃 𝚂𝙰𝙽𝚃𝙴𝚃`,
                            "jpegThumbnail": virgam
                        } 
                    } 
                }
            await jobotz.sendMessage(m.chat, {text:"𝚃𝙷𝙴 𝙲𝙰𝙷𝚈𝙾 𝙱𝙾𝚃 𝚂𝙰𝙽𝚃𝙴𝚃"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(m.chat, {text:"𝚃𝙷𝙴 𝙲𝙰𝙷𝚈𝙾 𝙱𝙾𝚃 𝚂𝙰𝙽𝚃𝙴𝚃"},{quoted:asukonyol11})
            await sleep(30000)
            await jobotz.sendMessage(m.chat, {text:"𝚃𝙷𝙴 𝙲𝙰𝙷𝚈𝙾 𝙱𝙾𝚃 𝚂𝙰𝙽𝚃𝙴𝚃"},{quoted:asukonyol11})
